...
class ItemRequestIntergrationalTest {
    ...
    void findOthersRequestsWithPage() {
        ItemRequestDto dto = ItemRequestDto.builder()
                ...
                .items(new ArrayList<>())
                .build();
        assertEquals(List.of(dto), itemRequestService.findOthersRequests(2, 1, 1),
    ...
    void findOthersRequestsWithoutPage() {
        ...
        ItemRequestDto dto2 = ItemRequestDto.builder()
                ...
                .items(new ArrayList<>())
                .build();
        assertEquals(List.of(dto2, dto1), itemRequestService.findOthersRequests(2, null, 1),
