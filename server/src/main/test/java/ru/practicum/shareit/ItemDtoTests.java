...
class ItemDtoTests {
    ...
    void itemDto() throws IOException {
        ...
        Assertions.assertEquals("{\"id\":1,\"name\":\"name\",\"description\":\"description\",\"available\":true,\"requestId\":1}",
    ...
    void itemDtoWithTime() throws IOException {
        ...
        Assertions.assertEquals("{\"id\":1,\"name\":\"name\",\"description\":\"description\",\"available\":true," +
