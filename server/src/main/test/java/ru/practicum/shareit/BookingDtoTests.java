...
class BookingDtoTests {
    ...
    void bookingDto() throws IOException {
        ...
        Assertions.assertEquals("{\"id\":1,\"item\":{\"id\":1,\"name\":\"name\",\"description\":\"description\"," +
    ...
    void bookingDtoShort() throws IOException {
        ...
        Assertions.assertEquals("{\"id\":1,\"bookerId\":1}", result.getJson(),
    ...
    void newBookingDto() throws IOException {
        ...
        Assertions.assertEquals("{\"itemId\":1,\"start\":\"1994-01-01T11:11:11\",\"end\":\"1994-01-01T12:11:11\"}",
