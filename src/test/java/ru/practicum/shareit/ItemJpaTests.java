...
class ItemJpaTests {
    ...
    void findAllWhereOwnerIdInWithPage() {
        ...
        Assertions.assertEquals(List.of(item1), itemRepository.findAllWhereOwnerIdIn(1, page).getContent());
    }
    ...
    void findAllWhereOwnerIdInWithoutPage() {
        ...
        Assertions.assertEquals(List.of(item1, item2, item3, item4), itemRepository.findAllWhereOwnerIdIn(1));
    }
    ...
    void findByNameWithPage() {
        ...
        Item item1 = new Item(1, "Item1", "description1", true, owner, null);
        Pageable page = PageRequest.of(0, 1);
        Assertions.assertEquals(List.of(item1), itemRepository.findByName("ItEm", page).getContent());
    }
    ...
    void findByNameWithoutPage() {
        ...
        Item item4 = new Item(4, "Item4", "description4", true, owner, request);
        request.setItems(List.of(item4));
        Assertions.assertEquals(List.of(item1, item2, item4), itemRepository.findByName("ItEm"));
    }
